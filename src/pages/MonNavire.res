...
let make = () => {
  ...
  | (true, None) =>
    // Affiche un message de chargement si les données utilisateur ne sont pas encore disponibles
  ...
  | (true, Some(user)) =>
    // Affiche les informations utilisateur et leurs decks
    <div className="container mx-auto p-4">
      ...
      </h2>
      {
        ...
        : <ul className="mt-4 space-y-4">
            {user.decks->Belt.Array.map(deck =>
              <li
                key=deck.slug
              ...
              >
                ...
                <p>{React.string("Nombre de cartes : " ++ string_of_int(Belt.Array.length(deck.cards))}</p>
                /* Affiche une image si le deck a au moins une carte */
                {
